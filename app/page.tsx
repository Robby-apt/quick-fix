...
import { ArrowRight, CheckCircle, Clock, MapPin, PenToolIcon as Tool, Wrench } from "lucide-react"
  ...
  const services = [
    {
      ...
      description: "Fix leaks, install fixtures, and solve all your plumbing needs with our expert plumbers.",
    },
    {
      title: "Electrical",
    ...
    },
    {
      ...
      description: "Repair or replace your roof with our skilled roofers who deliver quality workmanship.",
    },
  ]
  ...
  return (
    <div className="flex flex-col min-h-screen">
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center gap-8">
            <div className="flex-1 space-y-6">
              <h1 className="text-4xl md:text-6xl font-bold">Find Skilled Handymen In Your Area</h1>
              <p className="text-xl md:text-2xl">
                Connect with trusted professionals for plumbing, electrical, roofing, and more.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Button size="lg" variant="outline" className="bg-primary-foreground text-primary" asChild>
                  <Link href="/register/handyman">Join as a Handyman</Link>
                </Button>
              </div>
            </div>
      ...
      <section className="py-16 bg-background">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-12">How Quick Fix Works</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="flex flex-col items-center text-center p-6 rounded-lg border border-border">
              <div className="bg-primary/10 p-4 rounded-full mb-4">
                <MapPin className="h-8 w-8 text-primary" />
              </div>
              <h3 className="text-xl font-semibold mb-2">Find Local Professionals</h3>
              <p className="text-muted-foreground">Browse through our network of verified handymen in your area.</p>
            </div>
            <div className="flex flex-col items-center text-center p-6 rounded-lg border border-border">
              <div className="bg-primary/10 p-4 rounded-full mb-4">
              ...
              <p className="text-muted-foreground">Schedule a service at a time that works best for you.</p>
            </div>
            <div className="flex flex-col items-center text-center p-6 rounded-lg border border-border">
              <div className="bg-primary/10 p-4 rounded-full mb-4">
              ...
              <p className="text-muted-foreground">Sit back as our professionals handle your home repair needs.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-muted/50">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
            Quick Fix connects you with skilled professionals for all your home repair and maintenance needs.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      <section className="py-16 bg-background">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
            Don't just take our word for it. Here's what people are saying about Quick Fix.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
